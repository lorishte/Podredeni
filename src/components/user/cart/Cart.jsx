...
class Cart extends React.Component {
    ...
    render() {
        ...
        // No products
        if (this.state.productsCount === 0 && this.state.productsView) {
            return <Grid id="cart">
        ...
        if( this.state.products.length !== this.state.productsCount && this.state.productsView){
        ...
        return (
            <Grid id="cart">
                ...
                <Panel bsStyle="warning">
                    <Panel.Heading>
                        <Panel.Title componentClass="h3">ВАЖНО!</Panel.Title>
                    </Panel.Heading>
                    <Panel.Body>
                        Доставката се осъществява до 2 дни след направена заявка по куриерска фирма Еконт.
                        Разходите са за сметка на получателя, като при заявка над 60 лв, разходите са за
                        наша сметка. Заплащането се извършва с наложен платеж.</Panel.Body>
                </Panel>
