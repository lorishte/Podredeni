...
const productSefUrls = {
    ...
    [utils.generateRouteName("Очила за четене Брауни Блу")]: "a3a75ea3-3dcf-4c28-a319-5966334dccff",
    ...
    [utils.generateRouteName("Тюрбан Лавандула")]: "bb92f5bf-dc9e-457c-b055-3275c0365575",
    ...
    [utils.generateRouteName("Еко бързосъхнещи шорти Дъга")]: "418ffa90-c1ae-4c5f-8084-272b2307e1c1",
    ...
    [utils.generateRouteName("Кърпа за баня Бял Жасмин ")]: "1c7e2983-d7ba-412f-9fcc-a6f7547dd6a3",
    [utils.generateRouteName("Кърпа за баня Зелен Евкалипт")]: "7f45d1bc-8c99-4969-afd4-43da68c150b6",
    [utils.generateRouteName("Кърпа за баня Синьо Пачули")]: "f24506b6-17c9-42ba-87a2-55289998190a",
    [utils.generateRouteName("Кърпа за баня Сладък Портокал")]: "71358855-63b5-4a9a-aa4b-1f96c2d0b3bd",
    [utils.generateRouteName("Кърпа за баня Розов пипер")]: "49921dc0-1918-4dab-b90e-947ad50716b6",
    [utils.generateRouteName("Аромафорс Антивирусна Комбинация 5мл")]: "0b82bcb9-e149-4542-9d1b-3c240e961ce7",
    [utils.generateRouteName("Аромафорс Анти-микробен спрей")]: "c2e0543d-4865-446d-80ef-5e8029425687",
    [utils.generateRouteName("Аромафорс Спрей за нос")]: "b9193856-b090-4c9e-920a-4553b716ff3b",
    [utils.generateRouteName("OLEOCAPS 4 – Защитни сили")]: "b6818bab-88a5-4da5-b7eb-cd408cb95017",
    [utils.generateRouteName("Аромафорс Спрей за гърло")]: "8387b688-e8f7-4275-b61a-5219a30fd0c8",
    [utils.generateRouteName("Аромафорс Бронхиални капсули")]: "fdc80386-5a84-4972-9f5c-e996e82d013e",
    [utils.generateRouteName("Лимон БИО етерично масло")]: "a4e08b0b-2cad-4271-9825-b128e6cb6666",
    [utils.generateRouteName("Иланг-Иланг етерично масло")]: "f8ed1e1c-a671-49d5-bc1c-b707b8e2b73d",
    [utils.generateRouteName("Пачули етерично масло")]: "563afb92-e359-487d-9c81-d09f73945306",
    [utils.generateRouteName("Грейпфрут БИО етерично масло")]: "a9ce4993-df1c-40b1-a03b-d22d845cd43a",
    [utils.generateRouteName("Сладък Портокал БИО етерично масло")]: "ece30abc-383d-41fe-8a8e-b4b2e528f9e0",
    [utils.generateRouteName("Чаено дърво Етерично масло")]: "33d23f10-c960-4f91-b6ef-ff78fb052b55",
